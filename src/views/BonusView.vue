...
<template>
        ...
        <div class="col-12 col-lg-6 mx-auto d-flex flex-column">
            ...
            <div class="card-body d-flex justify-content-between">
              <div class="left-card text-light">
                <div class="d-flex mb-3">
                  <p class="mb-0 fw-bold lead me-3">ROCK</p>
                  <p class="mb-0 fw-bold lead me-3">PAPER</p>
                  <p class="mb-0 fw-bold lead me-3">SCISSORS</p>
                </div>
                <div class="d-flex">
                  <p class="mb-0 fw-bold lead me-3">LIZARD</p>
                  <p class="mb-0 fw-bold lead me-3">SPOCK</p>
                </div>
              </div>
            ...
            <div v-if="!startGame" class="row flex-grow-1 align-items-center">
              <div class="col">
                <div class="content mx-auto mt-5" style="width: 300px">
                  <img src="/bg-pentagon.svg" alt="pentagon" class="img-fluid w-100 d-block mx-auto">
                  <button class="scissors btn bg-light pentagon" @click="gameStore.bonusHumanPick('scissors')">
                    <img src="/icon-scissors.svg" alt="scissors">
                  </button>
                  <button class="paper btn bg-light pentagon" @click="gameStore.bonusHumanPick('paper')">
                    <img src="/icon-paper.svg" alt="paper">
                  </button>
                  <button class="rock btn bg-light pentagon" @click="gameStore.bonusHumanPick('rock')">
                    <img src="/icon-rock.svg" alt="rock">
                  </button>
                  <button class="lizard btn bg-light pentagon" @click="gameStore.bonusHumanPick('lizard')">
                    <img src="/icon-lizard.svg" alt="lizard">
                  </button>
                  <button class="spock btn bg-light pentagon" @click="gameStore.bonusHumanPick('spock')">
          ...
          <div class="row mt-auto mb-5">
            <div class="col d-flex justify-content-between">
              <RouterLink :to="{name: 'home'}" type="button" class="btn btn-outline-light px-4 py-2" style="color: hsl(229, 25%, 31%)">HOME</RouterLink>
              <a type="button" class="btn btn-outline-light px-4 py-2" style="color: hsl(229, 25%, 31%)" data-bs-toggle="modal" data-bs-target="#bonusRulesModal">RULES</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <Teleport to="#modal">
    <!-- Modal -->
    <div class="modal fade" id="bonusRulesModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-body text-center">
          <img src="/image-rules-bonus.svg" alt="rules" class="img-fluid w-75">
        </div>
        </div>
      </div>
    </div>
